...
func (t *tree_node) _calculate_max_eigenvector() (*mat.VecDense, float64) {
	...
	col_1_vec := mat.VecDenseCopyOf(ev.RowView(1))
	col_2_vec := mat.VecDenseCopyOf(ev.RowView(2))
	col_0_vec_magnitude := _3DVecMagnitude(row_0_vec)
	col_1_vec_magnitude := _3DVecMagnitude(col_1_vec)
	col_2_vec_magnitude := _3DVecMagnitude(col_2_vec)

	current_vector = row_0_vec
	current_vector_magnitude = col_0_vec_magnitude
	if col_1_vec_magnitude > col_0_vec_magnitude {
		current_vector = col_1_vec
		current_vector_magnitude = col_1_vec_magnitude
	} else if col_2_vec_magnitude > col_1_vec_magnitude {
		current_vector = col_2_vec
		current_vector_magnitude = col_2_vec_magnitude
	}
